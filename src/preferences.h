...
#define DEFAULT_METAMODE_KEYS (keymap_t[]){{'e', NULL, "\x1b"}, {'t', NULL, "\x09"}}
#define DEFAULT_METAMODE_STICKY_KEYS_LEN 4
#define DEFAULT_METAMODE_STICKY_KEYS (keymap_t[]){{'k', NULL, "kcuu1"}, \
                                                  {'j', NULL, "kcud1"}, \
                                                  {'l', NULL, "kcuf1"}, \
                                                  {'h', NULL, "kcub1"}}
#define DEFAULT_METAMODE_FUNC_KEYS_LEN 10
#define DEFAULT_METAMODE_FUNC_KEYS (keymap_t[]){{'a', NULL, "alt_down"}, \
                                                {'c', NULL, "ctrl_down"}, \
                                                {'s', NULL, "rescreen"}, \
                                                {'v', NULL, "paste_clipboard"}, \
                                                {'m', NULL, "macro_menu"}, \
                                                {'u', NULL, "scroll_half_page_up"}, \
                                                {'d', NULL, "scroll_half_page_down"}, \
                                                {'b', NULL, "scroll_page_up"}, \
                                                {'f', NULL, "scroll_page_down"}, \
                                                {'g', NULL, "scroll_top"}}
...
#define DEFAULT_SYMMENU_ENTRIES (keymap_t[]) {  \
    ...
    {'a', NULL, "="}, {'s', NULL, "-"}, {'d', NULL, "*"}, {'f', NULL, "/"}, {'g', NULL, "\\"},{'h', NULL, "|"}, {'j', NULL, "&"}, {'k', NULL, "'"}, {'l', NULL, "\""} \
}
...
#define DEFAULT_BACKGROUND_KEEPALIVE 1

#define DEFAULT_ALTSYM_ENTRIES_LEN 27
#define DEFAULT_ALTSYM_ENTRIES (keymap_t[]) {  \
    {'q', NULL, "#"}, {'w', NULL, "1"}, {'e', NULL, "2"}, {'r', NULL, "3"}, {'t', NULL, "("}, {'y', NULL, ")"}, {'u', NULL, "_"}, {'i', NULL, "-"}, {'o', NULL, "+"}, {'p', NULL, "@"}, \
                {'a', NULL, "*"}, {'s', NULL, "4"}, {'d', NULL, "5"}, {'f', NULL, "6"}, {'g', NULL, "/"}, {'h', NULL, ":"}, {'j', NULL, ";"}, {'k', NULL, "'"}, {'l', NULL, "\""}, \
                {'z', NULL, "7"}, {'x', NULL, "8"}, {'c', NULL, "9"}, {'v', NULL, "?"}, {'b', NULL, "!"}, {'n', NULL, ","}, {'m', NULL, "."}, \
                            {'0', NULL, "0"} \
}

#define DEFAULT_PROJECT_MACROS_LEN 2
#define DEFAULT_PROJECT_MACROS (keymap_t[]) { \
	{'s', "SSH LAN", "ssh Admin@192.168.1.6\n"}, \
	{'a', "Anki Host", "cd \"C:\\Users\\Admin\\Desktop\\GIT CLONE\\ankiweb\\cli\" && python ankiweb_cli.py\n"} \
}
