...
#define SYMMENU_FRET       {.r = 74,  .g = 93,  .b = 110}
#define SYMMENU_BORDER     {.r = 24,  .g = 33,  .b = 42}
#define SYMMENU_BACKGROUND {.r = 46,  .g = 58,  .b = 72}
#define SYMMENU_CORNER     {.r = 166, .g = 190, .b = 214}
#define SYMMENU_FONT       {.r = 245, .g = 248, .b = 250}
#define SYMMENU_FLASH      {.r = 92,  .g = 145, .b = 196}
#define UI_ACCENT          {.r = 0,   .g = 186, .b = 255}
#define UI_PASTE           {.r = 255, .g = 196, .b = 61}
#define UI_SCROLL          {.r = 123, .g = 202, .b = 136}
